...
(function () {
  ...
  function majBouton(theme) {
    ...
    bouton.setAttribute(
      "title",
      sombre ? "Switch to the light theme" : "Switch to the dark theme"
    );
    var lbl = bouton.querySelector(".lbl");
    if (lbl) lbl.textContent = sombre ? "Light" : "Dark";
  }
  ...
  function creerBouton() {
    ...
    b.setAttribute("aria-label", "Toggle between the light and dark themes");
